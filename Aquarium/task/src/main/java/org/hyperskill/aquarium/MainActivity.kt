...
class MainActivity : AppCompatActivity() {
    ...
    private val imageAnimals = listOf(
    ...
    private val nameAnimals = listOf("Koi Carp", "Spiny Dogfish", "Kaluga")
    private val descriptionAnimals =
        listOf(
            //Koi Carp
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        animalAdapter = AnimalAdapter(imageAnimals, nameAnimals, descriptionAnimals)
        viewpager2.adapter = animalAdapter

        tabLayout = findViewById(R.id.tab_layout)

        for(item in 0..nameAnimals.size-1){
